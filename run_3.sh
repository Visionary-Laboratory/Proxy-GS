...
#  python train.py --eval -s data/hirarchy/small_city/camera_calibration/rectified -m ouputs/hier_smallcity_ours_base_1_04_wo_densify_tao10 \
#  --ply_path datasets/berlin/sparse/0/points3D.ply  \
#  --base_layer -1 --ply_mesh data/hirarchy/small_city/camera_calibration/rectified/tsdf_fusion_post_smallcity.ply \
#  --use_wandb

python render_real.py -m ouputs/hier_smallcity_ours_base_1_04_wo_densify_tao10 --skip_train --ply_path  data/hirarchy/small_city/camera_calibration/rectified/sparse/0/points3D.ply \
...
python metrics.py  -m ouputs/hier_smallcity_ours_base_1_04_wo_densify_tao10 -s data/hirarchy/small_city/camera_calibration/rectified/masks
