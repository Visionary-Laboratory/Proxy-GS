...
python train.py --eval -s data/small_city/street/pose/block_E -m ouputs_cvpr/block_E_moutain010 \
 --ply_path datasets/small_city/aerial/small_city_pointcloud/point_cloud_ds20/aerial/Block_E.ply  \
 --ply_mesh cvpr/block_E_moutain010.ply \
 --use_wandb

python render_real.py -m ouputs_cvpr/block_E_moutain010 --skip_train --ply_path  datasets/small_city/aerial/small_city_pointcloud/point_cloud_ds20/aerial/Block_E.ply \
 --ply_mesh cvpr/block_E_moutain010.ply -s data/small_city/street/pose/block_E




python metrics.py  -m ouputs_cvpr/block_E_moutain010 -s data/small_city/street/pose/block_E
